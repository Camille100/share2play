      ...
      <form onSubmit={(e) => handleSubmit(onSubmit, e)}>
        ...
        <div className="box-input">
          ...
          <input
            ...
            onChange={handleChange}
          />
          <div className="box-errors">{isSubmitted && errors.addressEmpty}</div>
        </div>
        ...
        <div className="zip-city-box">
          <div className="box-input zip">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <div className="box-errors">{isSubmitted && errors.zipEmpty}</div>
          </div>
          ...
          <div className="box-input">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <div className="box-errors">{isSubmitted && errors.cityEmpty}</div>
          </div>
        </div>
        ...
        <input type="submit" value="Envoyer" className="registration-button" />
      </form>
    </div>
  );
}
